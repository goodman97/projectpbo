...
public class LimasSegitiga extends Segitiga{
    ...
    public double hitungVolume(double newAlas, double newTinggiSegitiga, double tinggiLimas) {
        volume = (1.0 / 3.0) * super.hitungLuas(newAlas, newTinggiSegitiga) * tinggiLimas;
        return volume;
    }
    ...
    public double hitungLuasPermukaan(double newAlas, double newTinggiSegitiga, double tinggiLimas) {
        ...
        double luasSegitigaTegak = 0.5 * newAlas * tinggiSegitigaTegak;
        luasPermukaan = super.hitungLuas(newAlas, newTinggiSegitiga) + 3 * luasSegitigaTegak;
        return luasPermukaan;
    }
